  ...
  return (
    <div className="content">
      <section>
        ...
        You are about to delete the user group with the following details.
        <table className="rev-border-space" id="map-table">
          <tbody>
            <tr>
              ...
              <td className="text-align-left width-15per" id="user">
                Name
              </td>
              <td className="text-align-left full-width" id="user-table-name">
                Name
              </td>
            </tr>
            <tr>
              ...
              <td className="text-align-left full-width" id="user-table-time">
                Time
              </td>
            </tr>
            <tr>
              ...
              <td className="text-align-left full-width" id="user-table-users">
                0
              </td>
            </tr>
          </tbody>
